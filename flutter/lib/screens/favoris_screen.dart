                                      ...
                                      child: GestureDetector(
                                        onTap: () async {
                                          ...
                                          try {
                                            ...
                                            final current = doc.data()?['favoriteIds'] ?? [];
                                            final List<String> ids = List<String>.from(current);
                                            if (ids.contains(activity.id)) ids.remove(activity.id);
                                            else ids.add(activity.id);
                                            await docRef.update({'favoriteIds': ids});
                                          } catch (e) {
